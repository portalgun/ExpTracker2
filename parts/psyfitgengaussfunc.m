...
% function [PC,T,DP] = psyfitgengaussfunc(Xstd,Xcmp,mFit,sFit,bFit,DPcrt,nIntrvl,bPLOT,xLbl,yLbl,color,figh)
%
%   example call: % HEAVIER TAILS THAN GAUSSIAN
%                   PC = psyfitgengaussfunc([],[-5:.1:5],0,2,.5)
%
%                 % SAME    TAILS AS   GAUSSIAN (cause it's gaussian)
%                   PC = psyfitgengaussfunc([],[-5:.1:5],0,2,1,1,1,1)
%
%                 % LIGHTER TAILS THAN GAUSSIAN
%                   PC = psyfitgengaussfunc([],[-5:.1:5],0,2,2)
%
